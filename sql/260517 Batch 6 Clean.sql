-- Batch 6: 5 Success Companies
-- Aurelian, Lumina, Andean, Red Back, Rainy River
-- Date: 2026-05-17

PRAGMA foreign_keys = ON;

-- COMPANY 1: AURELIAN RESOURCES INC.
INSERT INTO company (name, isin, country, stock_exchange, listing_year, delisting_year, primary_commodity, fraud_flag, success_label) VALUES ('Aurelian Resources Inc.', NULL, 'Canada', 'TSX-V', 2003, 2008, 'Au', 0, 'success');
INSERT INTO person (vorname, nachname, education, country, production_ramp_up_experience, first_mention_year, bio_text) VALUES ('Patrick', 'Anderson', 'B.Sc. Geology, University of Toronto', 'Canada', 0, 2001, 'Founder, CEO Aurelian, Fruta del Norte discoverer');
INSERT INTO person (vorname, nachname, education, country, production_ramp_up_experience, first_mention_year, bio_text) VALUES ('Keith', 'Barron', 'PhD Geology, University of Western Ontario', 'Canada', 0, 2001, 'Co-Founder, VP Exploration Aurelian');
INSERT INTO person (vorname, nachname, education, country, production_ramp_up_experience, first_mention_year, bio_text) VALUES ('Stephen', 'Leary', 'B.Sc. Geology, University of Canterbury', 'New Zealand', 0, 2005, 'Exploration Manager Aurelian');
INSERT INTO role (person_id, company_id, role_type, start_date, end_date) SELECT (SELECT id FROM person WHERE vorname='Patrick' AND nachname='Anderson' LIMIT 1), (SELECT id FROM company WHERE name='Aurelian Resources Inc.' LIMIT 1), 'CEO', '2003-01-01', '2008-10-03';
INSERT INTO role (person_id, company_id, role_type, start_date, end_date) SELECT (SELECT id FROM person WHERE vorname='Keith' AND nachname='Barron' LIMIT 1), (SELECT id FROM company WHERE name='Aurelian Resources Inc.' LIMIT 1), 'VP Exploration', '2002-01-01', '2008-10-03';
INSERT INTO role (person_id, company_id, role_type, start_date, end_date) SELECT (SELECT id FROM person WHERE vorname='Stephen' AND nachname='Leary' LIMIT 1), (SELECT id FROM company WHERE name='Aurelian Resources Inc.' LIMIT 1), 'Chief Geologist', '2005-03-01', '2008-10-03';
INSERT INTO project (company_id, name, jurisdiction, primary_commodity, stage_at_acquisition, peak_stage) SELECT (SELECT id FROM company WHERE name='Aurelian Resources Inc.' LIMIT 1), 'Fruta del Norte', 'Ecuador', 'Au', 'PFS', 'Production';
INSERT INTO outcome (company_id, discovery_score, reserve_conversion_score, exit_production_score, peak_marketcap_score, total_score, exit_type, exit_year, peak_marketcap_cad_million) SELECT (SELECT id FROM company WHERE name='Aurelian Resources Inc.' LIMIT 1), 95, 65, 70, 80, 79.5, 'M&A', 2008, 1200;
INSERT INTO event (company_id, event_type, event_date, description) SELECT (SELECT id FROM company WHERE name='Aurelian Resources Inc.' LIMIT 1), 'Discovery', '2006-04-01', 'Fruta del Norte discovery announced';
INSERT INTO event (company_id, event_type, event_date, description) SELECT (SELECT id FROM company WHERE name='Aurelian Resources Inc.' LIMIT 1), 'Resource Estimate', '2007-10-31', 'Initial Resource: 13.7M oz Au, 22.4M oz Ag';
INSERT INTO event (company_id, event_type, event_date, description) SELECT (SELECT id FROM company WHERE name='Aurelian Resources Inc.' LIMIT 1), 'PFS', '2008-01-15', 'Preliminary Feasibility Study 95% complete';
INSERT INTO event (company_id, event_type, event_date, description) SELECT (SELECT id FROM company WHERE name='Aurelian Resources Inc.' LIMIT 1), 'M&A', '2008-07-24', 'Kinross announces acquisition for CAD 1.2B';

-- COMPANY 2: LUMINA COPPER CORP.
INSERT INTO company (name, isin, country, stock_exchange, listing_year, delisting_year, primary_commodity, fraud_flag, success_label) VALUES ('Lumina Copper Corp.', NULL, 'Canada', 'TSX-V', 2003, 2014, 'Cu', 0, 'success');
INSERT INTO person (vorname, nachname, education, country, production_ramp_up_experience, first_mention_year, bio_text) VALUES ('Ross', 'Beaty', NULL, 'Canada', 0, 2003, 'Founder, Lumina Group');
INSERT INTO person (vorname, nachname, education, country, production_ramp_up_experience, first_mention_year, bio_text) VALUES ('David', 'Strang', NULL, 'Canada', 0, 2008, 'CEO Lumina Copper');
INSERT INTO person (vorname, nachname, education, country, production_ramp_up_experience, first_mention_year, bio_text) VALUES ('Andrew', 'Carstensen', 'BA & MS Geology, University of Montana', 'Canada', 1, 2008, 'VP Exploration Lumina');
INSERT INTO role (person_id, company_id, role_type, start_date, end_date) SELECT (SELECT id FROM person WHERE vorname='David' AND nachname='Strang' LIMIT 1), (SELECT id FROM company WHERE name='Lumina Copper Corp.' LIMIT 1), 'CEO', '2008-01-01', '2014-08-19';
INSERT INTO role (person_id, company_id, role_type, start_date, end_date) SELECT (SELECT id FROM person WHERE vorname='Andrew' AND nachname='Carstensen' LIMIT 1), (SELECT id FROM company WHERE name='Lumina Copper Corp.' LIMIT 1), 'VP Exploration', '2008-01-01', '2014-08-19';
INSERT INTO project (company_id, name, jurisdiction, primary_commodity, stage_at_acquisition, peak_stage) SELECT (SELECT id FROM company WHERE name='Lumina Copper Corp.' LIMIT 1), 'Taca Taca', 'Salta Province, Argentina', 'Cu', 'PEA', 'PEA';
INSERT INTO outcome (company_id, discovery_score, reserve_conversion_score, exit_production_score, peak_marketcap_score, total_score, exit_type, exit_year, peak_marketcap_cad_million) SELECT (SELECT id FROM company WHERE name='Lumina Copper Corp.' LIMIT 1), 50, 85, 0, 65, 52.5, 'M&A', 2014, 470;
INSERT INTO event (company_id, event_type, event_date, description) SELECT (SELECT id FROM company WHERE name='Lumina Copper Corp.' LIMIT 1), 'Discovery', '2008-08-01', 'Lumina acquires Taca Taca for USD 1M';
INSERT INTO event (company_id, event_type, event_date, description) SELECT (SELECT id FROM company WHERE name='Lumina Copper Corp.' LIMIT 1), 'Resource Estimate', '2012-05-31', 'Updated Resource: 1.762 Gt Cu';
INSERT INTO event (company_id, event_type, event_date, description) SELECT (SELECT id FROM company WHERE name='Lumina Copper Corp.' LIMIT 1), 'PEA', '2013-04-09', 'PEA announced: USD 2.1B NPV';
INSERT INTO event (company_id, event_type, event_date, description) SELECT (SELECT id FROM company WHERE name='Lumina Copper Corp.' LIMIT 1), 'M&A', '2014-06-17', 'First Quantum acquires for CAD 470M';
